...
export default function ModalPedidosEnProceso(props: {
      ...
      <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-2xl shadow-xl max-w-3xl w-full max-h-[85vh] overflow-y-auto">
          <div class="flex justify-between items-center p-4 border-b sticky top-0 bg-white z-10">
            <h2 class="text-xl font-semibold">Pedidos en Proceso</h2>
            ...
            <table class="w-full text-sm">
              ...
              <tbody>
                <For each={props.pedidos}>
                  {(p) => {
                    const intensidad = Math.min((p.diasEnProceso ?? 0) / 20, 1);
                    const bgColor = `rgba(239, 68, 68, ${intensidad.toFixed(2)})`; // rojo tipo red-500
                    return (
                      <tr
