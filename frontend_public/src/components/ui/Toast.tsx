...
export default function Toast() {
  return (
    <Show when={toastMensaje()}>
      <div
        class="fixed top-20 left-1/2 z-[9999] flex items-center gap-3 p-4 pr-5 bg-white text-gray-800 rounded-xl shadow-lg border border-gray-200 transition-all duration-300 transform -translate-x-1/2"
        classList={{
