...
export function initModels(sequelize: Sequelize) {
  ...
  LogSesion.belongsTo(SesionAnonima, {
    as: "sesion",
    foreignKey: "sesionAnonimaId",
  });
  SesionAnonima.hasMany(LogSesion, {
    as: "logs",
    foreignKey: "sesionAnonimaId",
  });
  ...
  Producto.belongsToMany(Categoria, {
    as: "categoriasAdicionales", // ← cambiado
  ...
  Categoria.belongsToMany(Producto, {
    as: "productosAdicionales", // ← cambiado
    through: ProductoCategoria,
    foreignKey: "categoriaId",
    otherKey: "productoId",
  });
  ...
  HistorialCliente.belongsTo(UsuarioAdmin, {
    as: "admin",
  ...
  UsuarioAdmin.hasMany(Auditoria, {
    as: "auditorias",
    foreignKey: "usuarioAdminId",
  });
  UsuarioAdmin.hasMany(Notificacion, {
    as: "notificaciones",
  ...
  // PedidoDux
  PedidoDux.hasMany(PedidoProductoDux, {
    as: "productos",
    foreignKey: "pedido_dux_id",
  });
  PedidoProductoDux.belongsTo(PedidoDux, {
    as: "pedido",
    foreignKey: "pedido_dux_id",
  });

  Producto.belongsToMany(ItemMenu, {
    through: "ProductoItemMenu",
    as: "itemsMenu",
    foreignKey: "productoId",
  });

  ItemMenu.belongsToMany(Producto, {
    through: "ProductoItemMenu",
    as: "productos",
